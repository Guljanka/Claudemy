        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-foreground">HopeBridge</span>
            </Link>
            <p className="text-sm leading-6 text-muted-foreground">
              Making a Difference Today by providing food, education, medical support, emergency assistance, and scholarships.
            </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold leading-6 text-foreground">Organization</h3>
                <ul role="list" className="mt-6 space-y-4">
                  ...
                  <li>
                    <Link href="/programs" className="text-sm leading-6 text-muted-foreground hover:text-foreground">
                      Programs & Services
                    </Link>
                  </li>
                  <li>
                    <Link href="/success-stories" className="text-sm leading-6 text-muted-foreground hover:text-foreground">
                      Success Stories
                    </Link>
                  </li>
                </ul>
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  <li>
                    <Link href="/donate" className="text-sm leading-6 text-muted-foreground hover:text-foreground">
                      Donate
                    </Link>
                  </li>
                  <li>
                    <Link href="/volunteer" className="text-sm leading-6 text-muted-foreground hover:text-foreground">
                      Volunteer
                    </Link>
                  </li>
                  <li>
                    <Link href="/events" className="text-sm leading-6 text-muted-foreground hover:text-foreground">
                      Events
                    </Link>
                  </li>
                  <li>
